<style>
@font-face {
    font-family: "codigo"; /* Define a new font family called "codigo" */
    src: url("../../assets/BarcodeFont.ttf") format("truetype"); /* Load the .ttf font file */
}
</style>
...
@font-face {
    font-family: "codigo"; /* Define a new font family called "codigo" */
    src: url("../../assets/BarcodeFont.eot"); /* Load the .eot font file for Internet Explorer */
}
</style>
<![endif]-->
